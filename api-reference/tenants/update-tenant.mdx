...
description: "PATCH /v1/tenants/{product_slug} updates a direct child tenant's name and/or domain. Changing domain re-provisions Clearbit and Visual Visitor. Requires tenants:write."
---
