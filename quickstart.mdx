...
<Steps>
  <Step title="Get your API key">
    Log in to the [Knock2 dashboard](https://dashboard.knock2.ai/) and navigate to **Settings → API Keys**. Click **Create API Key**, give it a descriptive name (for example, `production-server`), and copy the generated key.
